...
export const initialMissions: Mission[] = [
  {
    ...
    description: 'Ve al distrito de almacenes en Madrona. Hay un cargamento de droga que interceptar.',
    objectives: [
      { id: 'obj1', text: 'Ir al almacén (zona marcada)', completed: false, targetPosition: [25, 0, 25] },
      { id: 'obj2', text: 'Eliminar a los pandilleros', completed: false },
      { id: 'obj3', text: 'Recoger la evidencia', completed: false, targetPosition: [27, 0, 27] },
    ],
    status: 'available',
    reward: 5000,
    city: 'madrona',
  },
  {
    ...
    objectives: [
      { id: 'obj2-1', text: 'Llegar a la zona de discotecas', completed: false, targetPosition: [195, 0, -105] },
      { id: 'obj2-2', text: 'Eliminar a los traficantes', completed: false },
    ],
    status: 'available',
    reward: 8000,
    city: 'barceloma',
  },
  {
    ...
    objectives: [
      { id: 'obj3-1', text: 'Ir al puerto de Valentia', completed: false, targetPosition: [150, 0, 160] },
      { id: 'obj3-2', text: 'Eliminar a los contrabandistas', completed: false },
    ],
    status: 'available',
    reward: 10000,
    city: 'valentia',
  },
  {
    ...
    objectives: [
      { id: 'obj4-1', text: 'Ir al territorio de las bandas', completed: false, targetPosition: [-150, 0, 140] },
      { id: 'obj4-2', text: 'Eliminar a los líderes', completed: false },
    ],
    status: 'available',
    reward: 12000,
    city: 'sevira',
  },
  {
    ...
    objectives: [
      { id: 'obj5-1', text: 'Infiltrar el casino', completed: false, targetPosition: [-115, 0, -165] },
      { id: 'obj5-2', text: 'Encontrar los documentos', completed: false, targetPosition: [-125, 0, -155] },
    ],
    status: 'available',
    reward: 20000,
    city: 'costadelsol',
