...
export const cities: CityZone[] = [
  { id: 'madrona', name: 'MADRONA', subtitle: 'Capital - Poder, policia y corrupcion', center: [0, 0, 0], radius: 58, color: '#c4a035' },
  { id: 'sevira', name: 'SEVIRA', subtitle: 'Industrial - Fabricas, energia y rutas grises', center: [-135, 0, 120], radius: 50, color: '#6f7e94' },
  { id: 'barceloma', name: 'BARCELOMA', subtitle: 'Residencial - Costa alta y vida civil', center: [135, 0, 118], radius: 48, color: '#d86aa6' },
  { id: 'valentia', name: 'VALENTIA', subtitle: 'Puerto - Gruas, contenedores y contrabando', center: [150, 0, -118], radius: 54, color: '#9f5cc6' },
  { id: 'costadelsol', name: 'COSTA DEL SOL', subtitle: 'Circuito - Carreteras, riesgo y dinero rapido', center: [-140, 0, -125], radius: 52, color: '#d58a49' },
];
